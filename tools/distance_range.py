...
def generate():
    ...
    plt.hist(rgbl_values, bins=200, alpha=0.4, label='RGB', density=True)
    plt.hist(hsv_values, bins=200, alpha=0.4, label='HSV', density=True)
    ...
    plt.hist(lab76l_values, bins=200, alpha=0.4, label='Lab', density=True)
