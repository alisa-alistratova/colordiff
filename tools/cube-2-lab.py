...
from colors import hsv_to_rgbl, HSV, lab76_to_rgbl, Lab76, rgb_to_lab76, rgbd_to_rgbl, rgbl_to_rgbd
...
# sparse_ticks = ticks[::4]

sparse_ticks = np.linspace(0.0, 1.0, 5)
